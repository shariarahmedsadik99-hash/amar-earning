...
export const translations = {
  bn: {
    ...
    referrals: {
      ...
      step3: "যখন রেফার করা ইউজার ৳১০০০ আয় করবে বা ৳১০০০ টাকার কাজ পোস্ট করবে, আপনি ৳২০ বোনাস পাবেন",
      milestoneNote: "বোনাস শুধুমাত্র তখনই দেওয়া হবে যখন রেফার করা ইউজার ৳১০০০ মাইলস্টোন অর্জন করবে।",
    ...
    faq: {
      ...
      items: {
        ...
        a6: "আপনার রেফারেল কোড ব্যবহার করে যারা রেজিস্টার করবে তাদের জন্য বোনাস পাবেন — কিন্তু শর্ত আছে। রেফার করা ইউজার যখন ৳১০০০ আয় করবে (কর্মী হিসেবে) অথবা ৳১০০০ টাকার কাজ পোস্ট করবে (কর্মাদাতা হিসেবে), তখনই আপনি ৳২০ বোনাস পাবেন।",
    ...
    userReports: {
      ...
      reportThisUser: "এই ইউজারকে রিপোর্ট করুন",
      reportWorker: "কর্মীকে রিপোর্ট করুন",
      reportEmployer: "কর্মাদাতাকে রিপোর্ট করুন",
      subtitle: "বিরোধের বিস্তারিত দিন। অ্যাডমিন পর্যালোচনা করে সিদ্ধান্ত নেবেন।",
      reason: "কারণ",
      detail: "বিস্তারিত বিবরণ (ঐচ্ছিক)",
      detailPlaceholder: "কী হয়েছে তা বিস্তারিত লিখুন (প্রমাণ, তারিখ ইত্যাদি)",
      submit: "রিপোর্ট জমা দিন",
      submitting: "জমা হচ্ছে...",
      submitted: "রিপোর্ট সফলভাবে জমা হয়েছে। অ্যাডমিন শীঘ্রই পর্যালোচনা করবেন।",
      // Reasons
      reasons: {
        NON_PAYMENT: "টাকা পরিশোধ করেনি",
        FAKE_ISSUE: "ভুয়া সমস্যা দেখিয়ে পেমেন্ট এড়িয়ে গেছে",
        WRONG_SUBMISSION: "ভুল বা অসম্পূর্ণ কাজ জমা দিয়েছে",
        ABUSE: "হয়রানি / আপত্তিকর আচরণ",
        SPAM: "স্প্যাম / প্রতারণা",
        OTHER: "অন্যান্য",
      },
      // Status
      status: {
      ...
      filedByMe: "আমার দাখিল করা",
      filedAgainstMe: "আমার বিরুদ্ধে",
      noReports: "কোনো রিপোর্ট নেই",
      reportedUser: "রিপোর্টকৃত ইউজার",
      reporter: "রিপোর্টকারী",
      relatedJob: "সম্পর্কিত কাজ",
      filedOn: "তারিখ",
      resolution: "সিদ্ধান্ত",
      noResolution: "এখনও সিদ্ধান্ত নেই",
    },

    adminDisputes: {
      title: "বিরোধ রিপোর্ট",
      subtitle: "ইউজারদের মধ্যে বিরোধের তালিকা",
      empty: "কোনো বিরোধ নেই",
      reporter: "রিপোর্টকারী",
      reported: "রিপোর্টকৃত",
      reason: "কারণ",
      detail: "বিস্তারিত",
      ...
      resolve: "সমাধান করুন",
      dismiss: "বাতিল করুন",
      resolutionLabel: "সিদ্ধান্ত",
      adminNote: "অ্যাডমিন নোট (ঐচ্ছিক)",
      adminNotePlaceholder: "সিদ্ধান্তের কারণ বা বিস্তারিত",
      resolutionOptions: {
        REFUND_WORKER: "কর্মীকে টাকা ফেরত দিন",
        WARN_REPORTED: "রিপোর্টকৃতকে সতর্ক করুন",
        SUSPEND_REPORTED: "রিপোর্টকৃতকে স্থগিত করুন",
        NO_ACTION: "কোনো ব্যবস্থা নয়",
        OTHER: "অন্যান্য",
      },
      filterAll: "সব",
      filterPending: "অপেক্ষমাণ",
      filterResolved: "সমাধান হয়েছে",
      filterDismissed: "বাতিল",
      confirmResolve: "আপনি কি নিশ্চিত যে এই রিপোর্টটি সমাধান করতে চান?",
      confirmDismiss: "আপনি কি নিশ্চিত যে এই রিপোর্টটি বাতিল করতে চান?",
      stats: {
        total: "মোট বিরোধ",
        pending: "অপেক্ষমাণ",
        resolved: "সমাধান হয়েছে",
        againstYou: "আপনার বিরুদ্ধে",
      },
    },
  },
  ...
  en: {
    ...
    referrals: {
      ...
      step3: "When the referred user earns ৳1000 or posts a ৳1000 job, you get ৳20 bonus",
      milestoneNote: "Bonus is only awarded when the referred user reaches the ৳1000 milestone.",
    ...
    faq: {
      ...
      items: {
        ...
        a6: "You earn a bonus for users who register with your referral code — but with a condition. The referred user must earn ৳1000 (as a worker) or post a job worth ৳1000 (as an employer) before you receive the ৳20 bonus.",
    ...
    userReports: {
      ...
      subtitle: "Provide dispute details. An admin will review and decide.",
      reason: "Reason",
      detail: "Detail (optional)",
      detailPlaceholder: "Describe what happened (proof, dates, etc.)",
      submit: "Submit Report",
      submitting: "Submitting...",
      submitted: "Report submitted successfully. Admin will review shortly.",
      // Reasons
      reasons: {
        NON_PAYMENT: "Did not pay after work",
        FAKE_ISSUE: "Invented fake issue to avoid payment",
        WRONG_SUBMISSION: "Submitted wrong or incomplete work",
        ABUSE: "Harassment / abusive behavior",
        SPAM: "Spam / scam",
        OTHER: "Other",
      },
      // Status
      ...
      filedByMe: "Filed by me",
      filedAgainstMe: "Filed against me",
    ...
    adminDisputes: {
      ...
      subtitle: "List of user-vs-user disputes",
      empty: "No disputes",
      reporter: "Reporter",
      reported: "Reported",
      reason: "Reason",
      ...
      adminNotePlaceholder: "Reason or details for the decision",
      resolutionOptions: {
        REFUND_WORKER: "Refund the worker",
        WARN_REPORTED: "Warn reported user",
        SUSPEND_REPORTED: "Suspend reported user",
        NO_ACTION: "No action",
        OTHER: "Other",
      },
      filterAll: "All",
